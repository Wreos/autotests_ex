...
class ProductPageLocators(object):
    ...
    MESSAGEAFTERADD=(By.XPATH, "//*[contains(text(), 'The shellcoder's handbook был добавлен в вашу корзину.')]")
    NAMEBOOKCART=(By.CSS_SELECTOR, '.alert:nth-child(1)>.alertinner strong')
    NAMEBOOK=(By.CSS_SELECTOR, '.col-sm-6 h1')
    MESSAGE_CART = (By.XPATH, "//*[contains(text(), 'Стоимость корзины теперь составляет')]")
